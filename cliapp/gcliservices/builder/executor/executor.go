...
func NewGeneratorExecutor(ctxScope app.Scope, sharedData SharedData, limit int64, templatesExecutor gcliservices.TemplatesExecutor) (instance *GeneratorExecutor, err error) {
