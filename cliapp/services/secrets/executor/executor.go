...
func NewSecretsExecutor(ctxScope app.Scope, sharedData SharedData, limit int64, templateExecutor services.TemplateExecutor) (instance *SecretsExecutor, err error) {
