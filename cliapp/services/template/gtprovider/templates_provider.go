...
type TemplatesProvider struct {
	...
	assetsProvider services.TemplateAssetsProvider
...
func NewTemplatesProvider(assetsProvider services.TemplateAssetsProvider, fs filesystem.Filespace, templatesPath string, isCached bool) *TemplatesProvider {
